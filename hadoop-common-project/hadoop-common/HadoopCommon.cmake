...
if (CMAKE_C_COMPILER_ID STREQUAL "GNU" OR
  ...
  if(NOT DEFINED GCC_SHARED_FLAGS)
    ...
    if(CMAKE_USE_PTHREADS_INIT)
      set(GCC_SHARED_FLAGS "-g -O2 -Wall -pthread -D_FILE_OFFSET_BITS=64 -Wno-error=implicit-function-declaration -Wno-error=reserved-user-defined-literal")
    else()
      set(GCC_SHARED_FLAGS "-g -O2 -Wall -D_FILE_OFFSET_BITS=64 -Wno-error=implicit-function-declaration -Wno-error=reserved-user-defined-literal")
    endif()
  endif()
endif()
